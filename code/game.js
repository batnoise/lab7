...
var wobbleSpeed = 8, wobbleDist = 0.07, wobbleDist2 = 0.22, wobbleSpeed2 = 15;
...
Player.prototype.moveY = function(step, level, keys) {
  //accelerate the player downwards always
  ...
  //only allow player to jump if touching an obstacle
  if (obstacle) {
...
function runGame(plans, Display) {
  ...
  startLevel(0);
  //remember, 0 is first level! change to 1, 2, etc to go right to higher levels in troubleshooting
}
